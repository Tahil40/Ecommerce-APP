...
const Product_information = ({add_to_cart}) => {
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <Link href={"http://localhost:3000/components/order"}><button className="flex ml-auto text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-white hover:text-black rounded">
                  Buy
                </button></Link>
                <button className="flex mx-2 text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-white hover:text-black rounded" onClick={()=>{add_to_cart(1, 1, 500, "wear the code", 'XL', 'Red')}}>
                  Add to cart
                </button>
              ...
              <br />
              <div className="flex">
                <input type="text" className="text-black px-2 border-2 hover:border-black" placeholder="Pincode" onChange={on_change}/>
                <button className="bg-black text-white mx-4 border-0 py-2 px-6 focus:outline-none hover:bg-white hover:text-black rounded" onClick={check_pincode}>Check</button>
              </div>                                                            
