...
const Gaming_laptop = ({product_props}) => {
  return (
    <>
      {/* Adding body content.......... */}
            ...
            {product_props.map((element)=>{
              return(
                ...
                <a className="block relative h-48 rounded overflow-hidden">
                  <Link href={"http://localhost:3000/components/gaming_laptop_info"}>
                    <img
                      alt="ecommerce"
                ...
                <Link href={"http://localhost:3000/components/gaming_laptop_info"}>
                  <div className="mt-4 cursor-pointer hover:underline">
                    ...
                    <span className="mt-1 border border-gray-300 px-1 hover:font-bold">14</span>
                    <span className="mt-1 border border-gray-300 px-1 mx-1 hover:font-bold">16</span>
...
export async function getServerSideProps(context){
  ...
  let product_data = await product.find({category:"Gaming Laptop"});
  return{
    props:{product_props: JSON.parse(JSON.stringify(product_data))}
  }
};

export default Gaming_laptop;
