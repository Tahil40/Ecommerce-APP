        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4">
            {Object.keys(product_variable).map((element)=>{                      
              return(
                <div key={product_variable[element]._id} className="lg:w-1/4 md:w-1/2 p-4 w-full hover:shadow-2xl shadow-xl rounded-2xl hover:rounded-md">
              ...
              <Link passHref={true} href={"http://localhost:3000/product/mackbook_info"}><div className="mt-4 cursor-pointer hover:underline">
...
// using getServerSideProps function to fetch data from database category wise....
export async function getServerSideProps(context){
  ...
  let mackbook_data = {}//create object which stores fetched data.... 
